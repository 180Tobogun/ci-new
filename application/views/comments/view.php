...
<?php foreach ($discussion_query->result() as $discussion_result) : ?>
	<h2>
		...
		<small><?php echo $this->lang->line('comments_created_by') . $discussion_result->name . $this->lang->line('comments_created_at') . $discussion_result->ds_created_at; ?></small>
	</h2>
...
<?php foreach ($comment_query->result() as $comment_result) : ?>
	<li class="media">
		...
		<div class="media-body">
			<h4 class="media-heading"><?php echo $comment_result->name . anchor('comments/flag/' . $comment_result->ds_id . '/' . $comment_result->cm_id, $this->lang->line('comments_flag')); ?></h4>
...
<div class="form-group col-md-5">
	...
	<input type="text" name="comment_name" class="form-control" id="comment_name"
...
<div class="form-group  col-md-10">
	...
	<textarea class="form-control" rows="3" name="comment_body"
			  id="comment_body"><?php echo set_value('comment_body'); ?></textarea>
</div>
